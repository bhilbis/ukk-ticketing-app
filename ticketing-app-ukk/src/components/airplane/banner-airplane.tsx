...
const AirplaneBanner = () => {
  ...
  return (
    <>
      <div className="relative w-full z-10 sm:h-[20rem] md:h-[23rem] xl:h-[31rem] 1xl:h-[38rem] overflow-hidden bg-[url('/airplane/clouds.jpg')] bg-cover bg-no-repeat">
        <div className="relative 1xl:pb-6 h-full w-full flex justify-center overflow-hidden">
          <div className="inset-0 mt-10 flex flex-col items-center justify-center text-black px-8 max-w-full md:max-w-md-content lg:max-w-lg-content xl:max-w-full  z-20  w-full">
            <h1 className="text-4xl font-bold mb-4">Penawaran Terbang Terbaik</h1>
              ...
              <button 
                ...
                className="bg-blue-base hover:bg-blue-400 py-2 px-4 rounded-md">Cari Penerbangan</button>
          </div>
        </div>
      </div>
