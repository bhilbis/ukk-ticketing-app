...
const AirplaneBanner = () => {
  ...
  return (
    <>
      <div className="relative w-full z-10 sm:h-[17rem] md:h-[20rem] xl:h-[28rem] 1xl:h-[35rem] overflow-hidden bg-[url('/airplane/clouds.jpg')] bg-cover bg-no-repeat object-bottom">
