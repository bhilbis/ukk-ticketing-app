...
const BannerTrain = () => {
  return (
    <div className="relative w-full z-10 sm:h-[24rem] md:h-[27rem] xl:h-[35rem] 1xl:h-[42rem] overflow-hidden bg-[url('/train/station1.jpg')] bg-cover bg-no-repeat bg-center">
